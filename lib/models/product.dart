...
List<Product> products = [
  ...
  Product(
    id: 2,
    price: 1299,
    title: " هاتف سامسونغ M12",
    subTitle: "  هاتف جد اقتصادي",
  ...
  Product(
      ...
      description:
          'تحتوي النضارات  على مجموعة من الاستشعار مثل أجهزة الاستشعار الحركية (مثل مستشعر الحركة وجيروسكوب) لتتبع حركات الرأس والعيون، مما يسمح للنظام بضبط العرض بناءً على حركات المستخدم لتوفير تجربة واقعية.'),
  Product(
    id: 4,
    price: 56,
    title: "سماعات",
